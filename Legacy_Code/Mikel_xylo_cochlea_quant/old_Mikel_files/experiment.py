...
def main():
    ...
    search_space = {
        ...
        "learning_rate": 1e-3,
        "hidden_threshold": tune.uniform(0.1,7),
    ...
    analysis = tune.run(
        ...
        name="MIKEL_LIF_NONquant_trial_6",
        storage_path=experiment_results,
        verbose=1,
        resume=False, # NOTE: resume is a Bool, check if "AUTO" works
    )
...
# NOTE: I have removed the quantisation with quantize=False in QuantLinear, to test the model without quantisation