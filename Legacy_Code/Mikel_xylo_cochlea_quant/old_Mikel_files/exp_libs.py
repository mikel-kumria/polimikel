...
class SNNQUT_filter_bank(nn.Module):
    def __init__(
        ...
        self.fc1 = QuantLinear(input_size, hidden_size, bits=bits, bias=False, quantize=False)
        self.lif1 = snn.Leaky(
            beta=beta_hidden_1,
            reset_mechanism=hidden_reset_mechanism,
            threshold=hidden_threshold,
        ...
        self.fc2 = QuantLinear(hidden_size, hidden_size, bits=bits, bias=False, quantize=False)
        self.lif2 = snn.Leaky(
            beta=beta_hidden_2,
            reset_mechanism=hidden_reset_mechanism,
            threshold=hidden_threshold,
        ...
        self.fc3 = QuantLinear(hidden_size, hidden_size, bits=bits, bias=False, quantize=False)
        self.lif3 = snn.Leaky(
            beta=beta_hidden_3,
            reset_mechanism=hidden_reset_mechanism,
            threshold=hidden_threshold,
        ...
        self.fc4 = QuantLinear(hidden_size, output_size, bits=bits, bias=False, quantize=False)
        self.lif4 = snn.Leaky(
            beta=beta_output,
            reset_mechanism=output_reset_mechanism,
            threshold=output_threshold,
