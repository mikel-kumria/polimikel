# Wave Order Recognition functions for generating synthetic datasets.
import numpy as np
import torch
...
class Wave_Order_Dataset(Dataset):
    ...
    def __init__(self, num_samples, sample_rate, duration, freq_min, freq_max, amp_min, amp_max, std_dev, offset):
        ...
        for _ in range(num_samples):
            ...
            phase1 = 0  # phase1 = np.random.uniform(0, 2 * np.pi)
            ...
            phase2 = 0  # phase2 = np.random.uniform(0, 2 * np.pi)
