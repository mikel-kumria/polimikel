...
class TemporalXORDataset(Dataset):
    def __init__(self, num_samples, v_th=2.0, seq_len=30):
        ...
        for _ in range(num_samples):
            ...
            seq[0:10, 0] = self.v_th if a == 1 else self.v_th / 2
            
            # Input neuron 2 (B): timesteps 10-20 active, rest 0
            seq[10:20, 1] = self.v_th if b == 1 else self.v_th / 2
            
            # Input neuron 3 (R): last 10 timesteps active with v_th
            seq[20:30, 2] = self.v_th
